...
// HebrewDate + TorahPortion are defined canonically in
// Core/Models/HebrewCalendarModels.swift (these were duplicated here, causing
// an invalid-redeclaration build error — removed).
