...
export const STREAK_MILESTONES: StreakMilestone[] = [
  {
    ...
    title: "Three Days In!",
    description:
      "You're building a rhythm with God. Small steps, big faithfulness.",
    icon: "leaf",
    scripture:
  ...
  },
  {
    ...
    description:
      "You've spent 7 consecutive days in God's Word. This is the foundation of a lifelong habit.",
    icon: "flame",
    scripture:
  ...
  },
  {
    ...
    description:
      "Two weeks of daily devotion. You're building spiritual muscle.",
    icon: "trending-up",
    scripture:
  ...
  },
  {
    ...
    description:
      "A full month walking with God daily. This is no longer a habit—it's who you are.",
    icon: "star",
    scripture:
  ...
  },
  {
    ...
    title: "Century Club!",
    description:
      "100 days of daily devotion. You're among the most committed believers using ChooseGOD.",
    icon: "trophy",
    scripture:
  ...
  },
  {
    ...
    description:
      "An entire year walking with God every single day. This is extraordinary faithfulness.",
    icon: "ribbon",
    scripture:
